    ...
    <div className="bg-white shadow-sm sticky top-0 z-10 border-b-primary border-b-2 py-1 sm:py-2">
      <div className="flex items-center px-4 sm:px-6 md:px-8 py-3 sm:py-4 gap-3 sm:gap-6">
        ...
        <div className="min-w-0">
          <p className="text-sm sm:text-base md:text-lg text-lessongray-600 truncate">{levelTitle}</p>
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-primary font-rubik truncate">{lessonTitle}</h2>
        </div>
      </div>
    </div>
  );
